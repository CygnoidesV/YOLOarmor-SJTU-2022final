...
class LoadImagesAndLabels(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if random.random() < hyp['edge_clip']:
            edge_plus=[0.3,0.5]
        ...
        # color_rate = random.random()
        # if color_rate < 0.33:
        #     img[:,:,0] = img[:,:,0]+(255-img[:,:,0])//30*(random.random()+1)
        # elif color_rate < 0.66:
        #     img[:,:,2] = img[:,:,2]+(255-img[:,:,0])//30*(random.random()+1)
            # Flip up-down
